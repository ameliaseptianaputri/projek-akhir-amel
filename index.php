...
<body>
    <div class="mx-6 py-3"  >
        ...
        <nav class="navbar mb-5 navbar-expand-lg navbar-light bg-white">
            <div class="container-fluid py-2">
                <a class="navbar-brand d-flex align-items-center">
                    <img src="images/wikrama-logo.png" class="img-fluid me-2" width="70" height="70" alt="">
        ...
        <div class="container-fluid hero" style="margin-bottom: 130px;">
            <div class="row">
                ...
                <div class=" mb-5 col-md-7 hero-desc">
                    ...
                    <button class="btn btn-primary btn-hero mt-3"><a style="color: white; text-decoration: none;" href="donasi.php">Beri Bantuan Shadaqah</button> </a>
                </div>
                <!-- Hero Image -->
                <div class=" mb-5 col-md-5 hero-bg d-flex justify-content-end">
                    <img src="images/masjiddd.jpeg" class="hero-image" />
                </div>
                <!-- Hero Card -->
                    ...
                    <div class="bg-primary py-3 text-white" style=" border-bottom-left-radius: 10px;  border-bottom-right-radius: 10px;">
                        <marquee width="100%" height="20%" direction="left" height="100px">
                            <ul class="d-flex m-0">
                                <li class="me-4 ms-4">
                                    Muhammad Ridwan - 
                                    <span class="text-warning">Uang : Rp.2.000.000</span>
                                </li>
                                <li class="me-4">Hamba Allah - 
                                    <span class="text-warning">Barang : Emas</span>
                                </li>
                                <li class="me-4">Siti Aisyah - 
                                    <span class="text-warning">Uang : Rp.2.000.000</span>
                                </li>
                            </ul>
                        </marquee>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style=" margin-bottom: 100px;">
            ...
            <div class="carousel-inner rounded">
                <div class="carousel-item active">
                    <img src="images/bnmasjid.jpeg" class="d-block w-100" style="height: 300px; background-size: cover;">
                </div>
                <div class="carousel-item">
                    <img src="images/bnmasjid1.jpeg" class="d-block w-100" style="height: 300px; background-size: cover;">
                </div>
                <div class="carousel-item">
                    <img src="images/bnmasjid2.jpeg" class="d-block w-100" style="height: 300px; background-size: cover;">
                </div>
            </div>
        ...
        <div class="benefit" style="margin-bottom: 100px;">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <img src="images/hand.png" style="height: 520px; width: 300px;">
                </div>
            </div>
        </div>
        <!-- End Benerfit -->
        ...
        <div class="step" style="margin-bottom: 100px;">
            <h1 class="fw-bold"><span class="text-primary"> Cara Melakukan Wakaf</span>, infaq<br> shodaqoh.</h1>
            <p class="text-secondary mb-5">Berikut adalah Cara melakukan wakaq, infaq shodaqoh untuk<br> membantu pembangunan masjid besar SMK Bogor</p>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="card shadow border-0">
                        <div class="card-body">
                            <b class="text-primary">01</b>
                            <h5 class="fw-bold">
                               Isi Form data diri
                            </h5>
                            <p class="text-secondary">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card shadow border-0">
                        <div class="card-body">
                            <b class="text-primary">02</b>
                            <h5 class="fw-bold">
                                Isikan nominal shodaqoh
                            </h5>
                            <p class="text-secondary">
                ...
                <div class="col-md-6 mb-3">
                    <div class="card shadow border-0">
                        <div class="card-body">
                            <b class="text-primary">03</b>
                            <h5 class="fw-bold">
                                Upload bukti pembayaran
                            </h5>
                            <p class="text-secondary">
                                Pilih motode pembayaran dan upload bukti <br> pembayaranya.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="gallery" style="margin-bottom: 100px;">
            ...
            <div class="row g-2">
                <div class="col-md-4 col-lg-3 col-sm-3 col-2">
                    <img src="images/g-1.png" class="w-100">
                </div>
                <div class="col-md-4 col-lg-3 col-sm-3 col-2">
                    <img src="images/g-2.png" class="w-100">
                </div>
                <div class="col-md-4 col-lg-3 col-sm-3 col-2">
                    <img src="images/g-3.png" class="w-100">
                </div>
                <div class="col-md-4 col-lg-3 col-sm-3 col-2">
                    <img src="images/g-4.png" class="w-100">
                </div>
                <div class="col-md-4 col-lg-3 col-sm-3 col-2">
                    <img src="images/g-2.png" class="w-100">
                </div>
                <div class="col-md-4 col-lg-3 col-sm-3 col-2">
                    <img src="images/g-5.png" class="w-100">
                </div>
                <div class="col-md-4 col-lg-3 col-sm-3 col-2">
                    <img src="images/g-1.png" class="w-100">
                </div>
    ...
    <!-- Start Contact -->
    <div class="overflow-hidden" style="background-color: #001E42; border-radius: 2%;">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-white">
                        ...
                        <div>
                            ...
                            <a><img src="images/tw.png"/></a>
                            <a><img src="images/ig.png"/></a>
                            <a><img src="images/yt.png"/></a>
                        </div>
                    </div>
                </div>
            </div>
